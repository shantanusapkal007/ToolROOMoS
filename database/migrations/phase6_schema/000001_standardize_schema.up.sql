...
ALTER TABLE analytics_kpis ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE analytics_kpis ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE analytics_kpis ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_analytics_kpis_company_id ON analytics_kpis(company_id);
CREATE INDEX IF NOT EXISTS idx_analytics_kpis_deleted_at ON analytics_kpis(deleted_at);

-- Fixes for analytics_revenue
ALTER TABLE analytics_revenue ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE analytics_revenue ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE analytics_revenue ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_analytics_revenue_company_id ON analytics_revenue(company_id);
...
ALTER TABLE analytics_machine_utilization ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE analytics_machine_utilization ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE analytics_machine_utilization ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_analytics_machine_utilization_company_id ON analytics_machine_utilization(company_id);
...
ALTER TABLE analytics_vendor_defects ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE analytics_vendor_defects ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE analytics_vendor_defects ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_analytics_vendor_defects_company_id ON analytics_vendor_defects(company_id);
...
-- Fixes for sessions
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_sessions_company_id ON sessions(company_id);
CREATE INDEX IF NOT EXISTS idx_sessions_deleted_at ON sessions(deleted_at);

-- Fixes for auth_attendance
ALTER TABLE auth_attendance ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE auth_attendance ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE auth_attendance ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_auth_attendance_company_id ON auth_attendance(company_id);
CREATE INDEX IF NOT EXISTS idx_auth_attendance_deleted_at ON auth_attendance(deleted_at);

-- Fixes for companies
ALTER TABLE companies ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE plants ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE departments ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_departments_deleted_at ON departments(deleted_at);

-- Fixes for modules
ALTER TABLE modules ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE modules ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE modules ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE permissions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE permissions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE user_roles ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE user_roles ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE role_permissions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE role_permissions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE audit_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE audit_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE change_requests ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_change_requests_deleted_at ON change_requests(deleted_at);

-- Fixes for change_impact_analyses
ALTER TABLE change_impact_analyses ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE change_impact_analyses ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE change_impact_analyses ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_change_impact_analyses_company_id ON change_impact_analyses(company_id);
...
ALTER TABLE change_notices ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE change_notices ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE change_notices ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_change_notices_company_id ON change_notices(company_id);
...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE rfqs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE rfqs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE expenses ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_expenses_company_id ON expenses(company_id);
CREATE INDEX IF NOT EXISTS idx_expenses_deleted_at ON expenses(deleted_at);

-- Fixes for copq_logs
ALTER TABLE copq_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE copq_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE copq_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_copq_logs_company_id ON copq_logs(company_id);
CREATE INDEX IF NOT EXISTS idx_copq_logs_deleted_at ON copq_logs(deleted_at);

-- Fixes for chart_of_accounts
ALTER TABLE chart_of_accounts ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE chart_of_accounts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE journal_entries ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE journal_lines ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE payment_receipts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE finance_purchase_orders ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_purchase_orders ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_purchase_orders ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_purchase_orders_company_id ON finance_purchase_orders(company_id);
...
ALTER TABLE finance_accounts ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_accounts ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_accounts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_accounts_company_id ON finance_accounts(company_id);
...
ALTER TABLE finance_journal_entries ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_journal_entries ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_journal_entries ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_journal_entries_company_id ON finance_journal_entries(company_id);
...
ALTER TABLE finance_journal_lines ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_journal_lines ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_journal_lines ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_journal_lines_company_id ON finance_journal_lines(company_id);
...
ALTER TABLE finance_projects ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_projects ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_projects ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_projects_company_id ON finance_projects(company_id);
CREATE INDEX IF NOT EXISTS idx_finance_projects_deleted_at ON finance_projects(deleted_at);

-- Fixes for finance_copq_logs
ALTER TABLE finance_copq_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_copq_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_copq_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_copq_logs_company_id ON finance_copq_logs(company_id);
CREATE INDEX IF NOT EXISTS idx_finance_copq_logs_deleted_at ON finance_copq_logs(deleted_at);

-- Fixes for finance_invoices
ALTER TABLE finance_invoices ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_invoices ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_invoices ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_invoices_company_id ON finance_invoices(company_id);
CREATE INDEX IF NOT EXISTS idx_finance_invoices_deleted_at ON finance_invoices(deleted_at);

-- Fixes for finance_expenses
ALTER TABLE finance_expenses ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE finance_expenses ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE finance_expenses ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_finance_expenses_company_id ON finance_expenses(company_id);
CREATE INDEX IF NOT EXISTS idx_finance_expenses_deleted_at ON finance_expenses(deleted_at);

-- Fixes for hrms_employees
ALTER TABLE hrms_employees ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE hrms_employees ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE hrms_employees ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_hrms_employees_company_id ON hrms_employees(company_id);
CREATE INDEX IF NOT EXISTS idx_hrms_employees_deleted_at ON hrms_employees(deleted_at);

-- Fixes for hrms_tasks
ALTER TABLE hrms_tasks ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE hrms_tasks ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE hrms_tasks ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_hrms_tasks_company_id ON hrms_tasks(company_id);
CREATE INDEX IF NOT EXISTS idx_hrms_tasks_deleted_at ON hrms_tasks(deleted_at);

-- Fixes for hrms_leaves
ALTER TABLE hrms_leaves ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE hrms_leaves ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE hrms_leaves ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_hrms_leaves_company_id ON hrms_leaves(company_id);
CREATE INDEX IF NOT EXISTS idx_hrms_leaves_deleted_at ON hrms_leaves(deleted_at);

-- Fixes for hrms_attendance
ALTER TABLE hrms_attendance ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE hrms_attendance ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE hrms_attendance ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_hrms_attendance_company_id ON hrms_attendance(company_id);
...
ALTER TABLE inventory_items ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE stock_transactions ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE stock_transactions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE stock_transactions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE inventory_delivery_challans ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE inventory_delivery_challans ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE inventory_delivery_challans ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_inventory_delivery_challans_company_id ON inventory_delivery_challans(company_id);
...
ALTER TABLE warehouses ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE cycle_counts ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE cycle_counts ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE cycle_counts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_cycle_counts_company_id ON cycle_counts(company_id);
CREATE INDEX IF NOT EXISTS idx_cycle_counts_deleted_at ON cycle_counts(deleted_at);

-- Fixes for abc_analysis
ALTER TABLE abc_analysis ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE abc_analysis ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE abc_analysis ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_abc_analysis_company_id ON abc_analysis(company_id);
CREATE INDEX IF NOT EXISTS idx_abc_analysis_deleted_at ON abc_analysis(deleted_at);

-- Fixes for material_heat_numbers
ALTER TABLE material_heat_numbers ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE material_heat_numbers ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE material_heat_numbers ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_material_heat_numbers_company_id ON material_heat_numbers(company_id);
...
ALTER TABLE material_certificates ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE material_certificates ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE material_certificates ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_material_certificates_company_id ON material_certificates(company_id);
CREATE INDEX IF NOT EXISTS idx_material_certificates_deleted_at ON material_certificates(deleted_at);

-- Fixes for machines
ALTER TABLE machines ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE machines ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE machines ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE maintenance_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE maintenance_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE maintenance_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE preventive_maintenance_schedules ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE preventive_maintenance_schedules ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE preventive_maintenance_schedules ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_preventive_maintenance_schedules_company_id ON preventive_maintenance_schedules(company_id);
...
ALTER TABLE machine_telemetry_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE machine_telemetry_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE machine_telemetry_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_machine_telemetry_logs_company_id ON machine_telemetry_logs(company_id);
CREATE INDEX IF NOT EXISTS idx_machine_telemetry_logs_deleted_at ON machine_telemetry_logs(deleted_at);

-- Fixes for shifts
ALTER TABLE shifts ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE shifts ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE shifts ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE production_jobs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE production_jobs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE production_jobs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_production_jobs_company_id ON production_jobs(company_id);
CREATE INDEX IF NOT EXISTS idx_production_jobs_deleted_at ON production_jobs(deleted_at);

-- Fixes for downtime_logs
ALTER TABLE downtime_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE downtime_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE downtime_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_downtime_logs_company_id ON downtime_logs(company_id);
CREATE INDEX IF NOT EXISTS idx_downtime_logs_deleted_at ON downtime_logs(deleted_at);

-- Fixes for travelers
ALTER TABLE travelers ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE travelers ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE travelers ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_travelers_company_id ON travelers(company_id);
CREATE INDEX IF NOT EXISTS idx_travelers_deleted_at ON travelers(deleted_at);

-- Fixes for traveler_stages
ALTER TABLE traveler_stages ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE traveler_stages ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE traveler_stages ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_traveler_stages_company_id ON traveler_stages(company_id);
CREATE INDEX IF NOT EXISTS idx_traveler_stages_deleted_at ON traveler_stages(deleted_at);

-- Fixes for machine_capacities
ALTER TABLE machine_capacities ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE machine_capacities ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE machine_capacities ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_machine_capacities_company_id ON machine_capacities(company_id);
...
ALTER TABLE production_schedules ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE production_schedules ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE production_schedules ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE oee_daily_metrics ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE oee_daily_metrics ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE oee_daily_metrics ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_oee_daily_metrics_company_id ON oee_daily_metrics(company_id);
CREATE INDEX IF NOT EXISTS idx_oee_daily_metrics_deleted_at ON oee_daily_metrics(deleted_at);

-- Fixes for quality_pfmeas
ALTER TABLE quality_pfmeas ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE quality_pfmeas ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE quality_pfmeas ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_quality_pfmeas_company_id ON quality_pfmeas(company_id);
CREATE INDEX IF NOT EXISTS idx_quality_pfmeas_deleted_at ON quality_pfmeas(deleted_at);

-- Fixes for quality_control_plans
ALTER TABLE quality_control_plans ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE quality_control_plans ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE quality_control_plans ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_quality_control_plans_company_id ON quality_control_plans(company_id);
CREATE INDEX IF NOT EXISTS idx_quality_control_plans_deleted_at ON quality_control_plans(deleted_at);

-- Fixes for gauge_rnrs
ALTER TABLE gauge_rnrs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE gauge_rnrs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE gauge_rnrs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_gauge_rnrs_company_id ON gauge_rnrs(company_id);
CREATE INDEX IF NOT EXISTS idx_gauge_rnrs_deleted_at ON gauge_rnrs(deleted_at);

-- Fixes for fais
ALTER TABLE fais ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE fais ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE fais ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_fais_company_id ON fais(company_id);
CREATE INDEX IF NOT EXISTS idx_fais_deleted_at ON fais(deleted_at);

-- Fixes for ppap_submissions
ALTER TABLE ppap_submissions ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE ppap_submissions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE ppap_submissions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_ppap_submissions_company_id ON ppap_submissions(company_id);
CREATE INDEX IF NOT EXISTS idx_ppap_submissions_deleted_at ON ppap_submissions(deleted_at);

-- Fixes for dimensional_reports
ALTER TABLE dimensional_reports ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE dimensional_reports ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE dimensional_reports ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_dimensional_reports_company_id ON dimensional_reports(company_id);
...
ALTER TABLE material_certifications ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE material_certifications ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE material_certifications ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_material_certifications_company_id ON material_certifications(company_id);
...
ALTER TABLE capability_reports ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE capability_reports ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE capability_reports ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_capability_reports_company_id ON capability_reports(company_id);
...
ALTER TABLE appearance_approval_reports ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE appearance_approval_reports ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE appearance_approval_reports ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_appearance_approval_reports_company_id ON appearance_approval_reports(company_id);
...
ALTER TABLE process_flow_diagrams ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE process_flow_diagrams ADD COLUMN IF NOT EXISTS deleted_by UUID;
CREATE INDEX IF NOT EXISTS idx_process_flow_diagrams_company_id ON process_flow_diagrams(company_id);
CREATE INDEX IF NOT EXISTS idx_process_flow_diagrams_deleted_at ON process_flow_diagrams(deleted_at);

-- Fixes for psws
ALTER TABLE psws ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE psws ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE psws ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_psws_company_id ON psws(company_id);
CREATE INDEX IF NOT EXISTS idx_psws_deleted_at ON psws(deleted_at);

-- Fixes for customer_complaints
ALTER TABLE customer_complaints ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE customer_complaints ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE customer_complaints ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_customer_complaints_company_id ON customer_complaints(company_id);
CREATE INDEX IF NOT EXISTS idx_customer_complaints_deleted_at ON customer_complaints(deleted_at);

-- Fixes for eight_d_reports
ALTER TABLE eight_d_reports ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE eight_d_reports ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE eight_d_reports ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_eight_d_reports_company_id ON eight_d_reports(company_id);
CREATE INDEX IF NOT EXISTS idx_eight_d_reports_deleted_at ON eight_d_reports(deleted_at);

-- Fixes for apqp_gate_reviews
ALTER TABLE apqp_gate_reviews ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE apqp_gate_reviews ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE apqp_gate_reviews ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_apqp_gate_reviews_company_id ON apqp_gate_reviews(company_id);
CREATE INDEX IF NOT EXISTS idx_apqp_gate_reviews_deleted_at ON apqp_gate_reviews(deleted_at);

-- Fixes for open_risk_trackers
ALTER TABLE open_risk_trackers ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE open_risk_trackers ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE open_risk_trackers ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_open_risk_trackers_company_id ON open_risk_trackers(company_id);
CREATE INDEX IF NOT EXISTS idx_open_risk_trackers_deleted_at ON open_risk_trackers(deleted_at);

-- Fixes for gauge_rnr_studies
ALTER TABLE gauge_rnr_studies ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE gauge_rnr_studies ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE gauge_rnr_studies ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_gauge_rnr_studies_company_id ON gauge_rnr_studies(company_id);
...
ALTER TABLE calibration_matrices ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE calibration_matrices ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE calibration_matrices ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_calibration_matrices_company_id ON calibration_matrices(company_id);
...
ALTER TABLE apqp_project_timelines ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE apqp_project_timelines ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE apqp_project_timelines ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_apqp_project_timelines_company_id ON apqp_project_timelines(company_id);
...
ALTER TABLE apqp_milestones ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE apqp_milestones ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE apqp_milestones ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_apqp_milestones_company_id ON apqp_milestones(company_id);
CREATE INDEX IF NOT EXISTS idx_apqp_milestones_deleted_at ON apqp_milestones(deleted_at);

-- Fixes for spc_studies
ALTER TABLE spc_studies ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE spc_studies ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE spc_studies ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_spc_studies_company_id ON spc_studies(company_id);
...
ALTER TABLE quotations ADD COLUMN IF NOT EXISTS deleted_by UUID;
...
ALTER TABLE cost_calculations ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE cost_calculations ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE cost_calculations ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE project_cost_analysis ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE project_cost_analysis ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE project_cost_analysis ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_project_cost_analysis_company_id ON project_cost_analysis(company_id);
...
ALTER TABLE workflow_definitions ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE workflow_definitions ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE workflow_steps ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE workflow_steps ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE workflow_steps ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_workflow_steps_company_id ON workflow_steps(company_id);
CREATE INDEX IF NOT EXISTS idx_workflow_steps_deleted_at ON workflow_steps(deleted_at);

-- Fixes for workflow_instances
ALTER TABLE workflow_instances ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE workflow_instances ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE workflow_instances ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
...
ALTER TABLE workflow_history ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE workflow_history ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE workflow_history ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_workflow_history_company_id ON workflow_history(company_id);
CREATE INDEX IF NOT EXISTS idx_workflow_history_deleted_at ON workflow_history(deleted_at);

-- Fixes for job_work_challans
ALTER TABLE job_work_challans ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE job_work_challans ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE job_work_challans ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_job_work_challans_company_id ON job_work_challans(company_id);
...
ALTER TABLE vendor_quality_scores ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE vendor_quality_scores ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE vendor_quality_scores ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_vendor_quality_scores_company_id ON vendor_quality_scores(company_id);
...
ALTER TABLE supplier_scorecards ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE supplier_scorecards ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_supplier_scorecards_company_id ON supplier_scorecards(company_id);

-- Fixes for supplier_ncrs
ALTER TABLE supplier_ncrs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE supplier_ncrs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_supplier_ncrs_company_id ON supplier_ncrs(company_id);

-- Fixes for supplier_audits
ALTER TABLE supplier_audits ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE supplier_audits ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_supplier_audits_company_id ON supplier_audits(company_id);

-- Fixes for tooling_projects
ALTER TABLE tooling_projects ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE tooling_projects ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE tooling_projects ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_tooling_projects_company_id ON tooling_projects(company_id);
CREATE INDEX IF NOT EXISTS idx_tooling_projects_deleted_at ON tooling_projects(deleted_at);

-- Fixes for tool_assets
ALTER TABLE tool_assets ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE tool_assets ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE tool_assets ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_tool_assets_company_id ON tool_assets(company_id);
CREATE INDEX IF NOT EXISTS idx_tool_assets_deleted_at ON tool_assets(deleted_at);

-- Fixes for tooling_life_logs
ALTER TABLE tooling_life_logs ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE tooling_life_logs ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE tooling_life_logs ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_tooling_life_logs_company_id ON tooling_life_logs(company_id);
...
ALTER TABLE refurbishment_tickets ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE refurbishment_tickets ADD COLUMN IF NOT EXISTS deleted_by UUID;
ALTER TABLE refurbishment_tickets ADD COLUMN IF NOT EXISTS version INT DEFAULT 1;
CREATE INDEX IF NOT EXISTS idx_refurbishment_tickets_company_id ON refurbishment_tickets(company_id);
...
ALTER TABLE drawing_vault_documents ADD COLUMN IF NOT EXISTS company_id UUID;
...
ALTER TABLE drawing_vault_documents ADD COLUMN IF NOT EXISTS deleted_by UUID;
CREATE INDEX IF NOT EXISTS idx_drawing_vault_documents_company_id ON drawing_vault_documents(company_id);
