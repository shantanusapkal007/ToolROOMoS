...
ALTER TABLE analytics_kpis DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE analytics_kpis DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE analytics_kpis DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_analytics_kpis_company_id;
DROP INDEX IF EXISTS idx_analytics_kpis_deleted_at;

-- Revert fixes for analytics_revenue
ALTER TABLE analytics_revenue DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE analytics_revenue DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE analytics_revenue DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_analytics_revenue_company_id;
DROP INDEX IF EXISTS idx_analytics_revenue_deleted_at;

-- Revert fixes for analytics_machine_utilization
ALTER TABLE analytics_machine_utilization DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE analytics_machine_utilization DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE analytics_machine_utilization DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_analytics_machine_utilization_company_id;
DROP INDEX IF EXISTS idx_analytics_machine_utilization_deleted_at;

-- Revert fixes for analytics_vendor_defects
ALTER TABLE analytics_vendor_defects DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE analytics_vendor_defects DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE analytics_vendor_defects DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_analytics_vendor_defects_company_id;
...
DROP INDEX IF EXISTS idx_sessions_company_id;
DROP INDEX IF EXISTS idx_sessions_deleted_at;

-- Revert fixes for auth_attendance
ALTER TABLE auth_attendance DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE auth_attendance DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE auth_attendance DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_auth_attendance_company_id;
...
ALTER TABLE companies DROP COLUMN IF EXISTS version;
...
ALTER TABLE plants DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE plants DROP COLUMN IF EXISTS version;
...
ALTER TABLE departments DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE modules DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE modules DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE permissions DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE permissions DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_permissions_company_id;
...
ALTER TABLE user_roles DROP COLUMN IF EXISTS version;
...
ALTER TABLE role_permissions DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE role_permissions DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE role_permissions DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_role_permissions_company_id;
...
ALTER TABLE audit_logs DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE change_requests DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE change_requests DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_change_requests_deleted_at;

-- Revert fixes for change_impact_analyses
ALTER TABLE change_impact_analyses DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE change_impact_analyses DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE change_impact_analyses DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_change_impact_analyses_company_id;
DROP INDEX IF EXISTS idx_change_impact_analyses_deleted_at;

-- Revert fixes for change_notices
ALTER TABLE change_notices DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE change_notices DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE change_notices DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_change_notices_company_id;
...
ALTER TABLE customers DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE contacts DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE rfqs DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE copq_logs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE copq_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE copq_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_copq_logs_company_id;
...
ALTER TABLE chart_of_accounts DROP COLUMN IF EXISTS version;
...
ALTER TABLE journal_entries DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_journal_entries_company_id;

-- Revert fixes for journal_lines
ALTER TABLE journal_lines DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE journal_lines DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_journal_lines_company_id;

-- Revert fixes for payment_receipts
ALTER TABLE payment_receipts DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE payment_receipts DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_payment_receipts_company_id;

-- Revert fixes for finance_purchase_orders
ALTER TABLE finance_purchase_orders DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_purchase_orders DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_purchase_orders DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_purchase_orders_company_id;
DROP INDEX IF EXISTS idx_finance_purchase_orders_deleted_at;

-- Revert fixes for finance_accounts
ALTER TABLE finance_accounts DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_accounts DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_accounts DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_accounts_company_id;
DROP INDEX IF EXISTS idx_finance_accounts_deleted_at;

-- Revert fixes for finance_journal_entries
ALTER TABLE finance_journal_entries DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_journal_entries DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_journal_entries DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_journal_entries_company_id;
DROP INDEX IF EXISTS idx_finance_journal_entries_deleted_at;

-- Revert fixes for finance_journal_lines
ALTER TABLE finance_journal_lines DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_journal_lines DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_journal_lines DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_journal_lines_company_id;
DROP INDEX IF EXISTS idx_finance_journal_lines_deleted_at;

-- Revert fixes for finance_projects
ALTER TABLE finance_projects DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_projects DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_projects DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_projects_company_id;
DROP INDEX IF EXISTS idx_finance_projects_deleted_at;

-- Revert fixes for finance_copq_logs
ALTER TABLE finance_copq_logs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_copq_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_copq_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_copq_logs_company_id;
DROP INDEX IF EXISTS idx_finance_copq_logs_deleted_at;

-- Revert fixes for finance_invoices
ALTER TABLE finance_invoices DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_invoices DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_invoices DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_invoices_company_id;
DROP INDEX IF EXISTS idx_finance_invoices_deleted_at;

-- Revert fixes for finance_expenses
ALTER TABLE finance_expenses DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE finance_expenses DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE finance_expenses DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_finance_expenses_company_id;
DROP INDEX IF EXISTS idx_finance_expenses_deleted_at;

-- Revert fixes for hrms_employees
ALTER TABLE hrms_employees DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE hrms_employees DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE hrms_employees DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_hrms_employees_company_id;
DROP INDEX IF EXISTS idx_hrms_employees_deleted_at;

-- Revert fixes for hrms_tasks
ALTER TABLE hrms_tasks DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE hrms_tasks DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE hrms_tasks DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_hrms_tasks_company_id;
DROP INDEX IF EXISTS idx_hrms_tasks_deleted_at;

-- Revert fixes for hrms_leaves
ALTER TABLE hrms_leaves DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE hrms_leaves DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE hrms_leaves DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_hrms_leaves_company_id;
DROP INDEX IF EXISTS idx_hrms_leaves_deleted_at;

-- Revert fixes for hrms_attendance
ALTER TABLE hrms_attendance DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE hrms_attendance DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE hrms_attendance DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_hrms_attendance_company_id;
DROP INDEX IF EXISTS idx_hrms_attendance_deleted_at;

-- Revert fixes for inventory_items
ALTER TABLE inventory_items DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE inventory_items DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE inventory_items DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_inventory_items_company_id;
DROP INDEX IF EXISTS idx_inventory_items_deleted_at;

-- Revert fixes for stock_transactions
ALTER TABLE stock_transactions DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE stock_transactions DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE stock_transactions DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_stock_transactions_company_id;
DROP INDEX IF EXISTS idx_stock_transactions_deleted_at;

-- Revert fixes for inventory_delivery_challans
ALTER TABLE inventory_delivery_challans DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE inventory_delivery_challans DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE inventory_delivery_challans DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_inventory_delivery_challans_company_id;
...
ALTER TABLE warehouses DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE warehouses DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_warehouses_company_id;
DROP INDEX IF EXISTS idx_warehouses_deleted_at;

-- Revert fixes for cycle_counts
ALTER TABLE cycle_counts DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE cycle_counts DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE cycle_counts DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_cycle_counts_company_id;
DROP INDEX IF EXISTS idx_cycle_counts_deleted_at;

-- Revert fixes for abc_analysis
ALTER TABLE abc_analysis DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE abc_analysis DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE abc_analysis DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_abc_analysis_company_id;
DROP INDEX IF EXISTS idx_abc_analysis_deleted_at;

-- Revert fixes for material_heat_numbers
ALTER TABLE material_heat_numbers DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE material_heat_numbers DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE material_heat_numbers DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_material_heat_numbers_company_id;
DROP INDEX IF EXISTS idx_material_heat_numbers_deleted_at;

-- Revert fixes for material_certificates
ALTER TABLE material_certificates DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE material_certificates DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE material_certificates DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_material_certificates_company_id;
DROP INDEX IF EXISTS idx_material_certificates_deleted_at;

-- Revert fixes for machines
ALTER TABLE machines DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE machines DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE machines DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_machines_company_id;
...
ALTER TABLE maintenance_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE maintenance_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_maintenance_logs_company_id;
DROP INDEX IF EXISTS idx_maintenance_logs_deleted_at;

-- Revert fixes for preventive_maintenance_schedules
ALTER TABLE preventive_maintenance_schedules DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE preventive_maintenance_schedules DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE preventive_maintenance_schedules DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_preventive_maintenance_schedules_company_id;
DROP INDEX IF EXISTS idx_preventive_maintenance_schedules_deleted_at;

-- Revert fixes for machine_telemetry_logs
ALTER TABLE machine_telemetry_logs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE machine_telemetry_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE machine_telemetry_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_machine_telemetry_logs_company_id;
...
ALTER TABLE shifts DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE shifts DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_shifts_company_id;
DROP INDEX IF EXISTS idx_shifts_deleted_at;

-- Revert fixes for production_jobs
ALTER TABLE production_jobs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE production_jobs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE production_jobs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_production_jobs_company_id;
DROP INDEX IF EXISTS idx_production_jobs_deleted_at;

-- Revert fixes for downtime_logs
ALTER TABLE downtime_logs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE downtime_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE downtime_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_downtime_logs_company_id;
DROP INDEX IF EXISTS idx_downtime_logs_deleted_at;

-- Revert fixes for travelers
ALTER TABLE travelers DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE travelers DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE travelers DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_travelers_company_id;
DROP INDEX IF EXISTS idx_travelers_deleted_at;

-- Revert fixes for traveler_stages
ALTER TABLE traveler_stages DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE traveler_stages DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE traveler_stages DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_traveler_stages_company_id;
DROP INDEX IF EXISTS idx_traveler_stages_deleted_at;

-- Revert fixes for machine_capacities
ALTER TABLE machine_capacities DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE machine_capacities DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE machine_capacities DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_machine_capacities_company_id;
DROP INDEX IF EXISTS idx_machine_capacities_deleted_at;

-- Revert fixes for production_schedules
ALTER TABLE production_schedules DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE production_schedules DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE production_schedules DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_production_schedules_company_id;
DROP INDEX IF EXISTS idx_production_schedules_deleted_at;

-- Revert fixes for oee_daily_metrics
ALTER TABLE oee_daily_metrics DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE oee_daily_metrics DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE oee_daily_metrics DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_oee_daily_metrics_company_id;
DROP INDEX IF EXISTS idx_oee_daily_metrics_deleted_at;

-- Revert fixes for quality_pfmeas
ALTER TABLE quality_pfmeas DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE quality_pfmeas DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE quality_pfmeas DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_quality_pfmeas_company_id;
DROP INDEX IF EXISTS idx_quality_pfmeas_deleted_at;

-- Revert fixes for quality_control_plans
ALTER TABLE quality_control_plans DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE quality_control_plans DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE quality_control_plans DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_quality_control_plans_company_id;
DROP INDEX IF EXISTS idx_quality_control_plans_deleted_at;

-- Revert fixes for gauge_rnrs
ALTER TABLE gauge_rnrs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE gauge_rnrs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE gauge_rnrs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_gauge_rnrs_company_id;
DROP INDEX IF EXISTS idx_gauge_rnrs_deleted_at;

-- Revert fixes for fais
ALTER TABLE fais DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE fais DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE fais DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_fais_company_id;
DROP INDEX IF EXISTS idx_fais_deleted_at;

-- Revert fixes for ppap_submissions
ALTER TABLE ppap_submissions DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE ppap_submissions DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE ppap_submissions DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_ppap_submissions_company_id;
DROP INDEX IF EXISTS idx_ppap_submissions_deleted_at;

-- Revert fixes for dimensional_reports
ALTER TABLE dimensional_reports DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE dimensional_reports DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE dimensional_reports DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_dimensional_reports_company_id;
DROP INDEX IF EXISTS idx_dimensional_reports_deleted_at;

-- Revert fixes for material_certifications
ALTER TABLE material_certifications DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE material_certifications DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE material_certifications DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_material_certifications_company_id;
DROP INDEX IF EXISTS idx_material_certifications_deleted_at;

-- Revert fixes for capability_reports
ALTER TABLE capability_reports DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE capability_reports DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE capability_reports DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_capability_reports_company_id;
DROP INDEX IF EXISTS idx_capability_reports_deleted_at;

-- Revert fixes for appearance_approval_reports
ALTER TABLE appearance_approval_reports DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE appearance_approval_reports DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE appearance_approval_reports DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_appearance_approval_reports_company_id;
DROP INDEX IF EXISTS idx_appearance_approval_reports_deleted_at;

-- Revert fixes for process_flow_diagrams
ALTER TABLE process_flow_diagrams DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE process_flow_diagrams DROP COLUMN IF EXISTS deleted_by;
DROP INDEX IF EXISTS idx_process_flow_diagrams_company_id;
DROP INDEX IF EXISTS idx_process_flow_diagrams_deleted_at;

-- Revert fixes for psws
ALTER TABLE psws DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE psws DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE psws DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_psws_company_id;
DROP INDEX IF EXISTS idx_psws_deleted_at;

-- Revert fixes for customer_complaints
ALTER TABLE customer_complaints DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE customer_complaints DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE customer_complaints DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_customer_complaints_company_id;
DROP INDEX IF EXISTS idx_customer_complaints_deleted_at;

-- Revert fixes for eight_d_reports
ALTER TABLE eight_d_reports DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE eight_d_reports DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE eight_d_reports DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_eight_d_reports_company_id;
DROP INDEX IF EXISTS idx_eight_d_reports_deleted_at;

-- Revert fixes for apqp_gate_reviews
ALTER TABLE apqp_gate_reviews DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE apqp_gate_reviews DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE apqp_gate_reviews DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_apqp_gate_reviews_company_id;
DROP INDEX IF EXISTS idx_apqp_gate_reviews_deleted_at;

-- Revert fixes for open_risk_trackers
ALTER TABLE open_risk_trackers DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE open_risk_trackers DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE open_risk_trackers DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_open_risk_trackers_company_id;
DROP INDEX IF EXISTS idx_open_risk_trackers_deleted_at;

-- Revert fixes for gauge_rnr_studies
ALTER TABLE gauge_rnr_studies DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE gauge_rnr_studies DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE gauge_rnr_studies DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_gauge_rnr_studies_company_id;
DROP INDEX IF EXISTS idx_gauge_rnr_studies_deleted_at;

-- Revert fixes for calibration_matrices
ALTER TABLE calibration_matrices DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE calibration_matrices DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE calibration_matrices DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_calibration_matrices_company_id;
DROP INDEX IF EXISTS idx_calibration_matrices_deleted_at;

-- Revert fixes for apqp_project_timelines
ALTER TABLE apqp_project_timelines DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE apqp_project_timelines DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE apqp_project_timelines DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_apqp_project_timelines_company_id;
DROP INDEX IF EXISTS idx_apqp_project_timelines_deleted_at;

-- Revert fixes for apqp_milestones
ALTER TABLE apqp_milestones DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE apqp_milestones DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE apqp_milestones DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_apqp_milestones_company_id;
DROP INDEX IF EXISTS idx_apqp_milestones_deleted_at;

-- Revert fixes for spc_studies
ALTER TABLE spc_studies DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE spc_studies DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE spc_studies DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_spc_studies_company_id;
...
ALTER TABLE quotations DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE cost_calculations DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE cost_calculations DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE cost_calculations DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_cost_calculations_company_id;
DROP INDEX IF EXISTS idx_cost_calculations_deleted_at;

-- Revert fixes for project_cost_analysis
ALTER TABLE project_cost_analysis DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE project_cost_analysis DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE project_cost_analysis DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_project_cost_analysis_company_id;
DROP INDEX IF EXISTS idx_project_cost_analysis_deleted_at;

-- Revert fixes for workflow_definitions
ALTER TABLE workflow_definitions DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE workflow_definitions DROP COLUMN IF EXISTS deleted_by;
...
ALTER TABLE workflow_steps DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE workflow_steps DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE workflow_steps DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_workflow_steps_company_id;
DROP INDEX IF EXISTS idx_workflow_steps_deleted_at;

-- Revert fixes for workflow_instances
ALTER TABLE workflow_instances DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE workflow_instances DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE workflow_instances DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_workflow_instances_company_id;
DROP INDEX IF EXISTS idx_workflow_instances_deleted_at;

-- Revert fixes for workflow_history
ALTER TABLE workflow_history DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE workflow_history DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE workflow_history DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_workflow_history_company_id;
DROP INDEX IF EXISTS idx_workflow_history_deleted_at;

-- Revert fixes for job_work_challans
ALTER TABLE job_work_challans DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE job_work_challans DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE job_work_challans DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_job_work_challans_company_id;
DROP INDEX IF EXISTS idx_job_work_challans_deleted_at;

-- Revert fixes for vendor_quality_scores
ALTER TABLE vendor_quality_scores DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE vendor_quality_scores DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE vendor_quality_scores DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_vendor_quality_scores_company_id;
DROP INDEX IF EXISTS idx_vendor_quality_scores_deleted_at;

-- Revert fixes for supplier_scorecards
ALTER TABLE supplier_scorecards DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE supplier_scorecards DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_supplier_scorecards_company_id;

-- Revert fixes for supplier_ncrs
ALTER TABLE supplier_ncrs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE supplier_ncrs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_supplier_ncrs_company_id;

-- Revert fixes for supplier_audits
ALTER TABLE supplier_audits DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE supplier_audits DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_supplier_audits_company_id;

-- Revert fixes for tooling_projects
ALTER TABLE tooling_projects DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE tooling_projects DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE tooling_projects DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_tooling_projects_company_id;
DROP INDEX IF EXISTS idx_tooling_projects_deleted_at;

-- Revert fixes for tool_assets
ALTER TABLE tool_assets DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE tool_assets DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE tool_assets DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_tool_assets_company_id;
DROP INDEX IF EXISTS idx_tool_assets_deleted_at;

-- Revert fixes for tooling_life_logs
ALTER TABLE tooling_life_logs DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE tooling_life_logs DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE tooling_life_logs DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_tooling_life_logs_company_id;
DROP INDEX IF EXISTS idx_tooling_life_logs_deleted_at;

-- Revert fixes for refurbishment_tickets
ALTER TABLE refurbishment_tickets DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE refurbishment_tickets DROP COLUMN IF EXISTS deleted_by;
ALTER TABLE refurbishment_tickets DROP COLUMN IF EXISTS version;
DROP INDEX IF EXISTS idx_refurbishment_tickets_company_id;
DROP INDEX IF EXISTS idx_refurbishment_tickets_deleted_at;

-- Revert fixes for drawing_vault_documents
ALTER TABLE drawing_vault_documents DROP COLUMN IF EXISTS company_id;
...
ALTER TABLE drawing_vault_documents DROP COLUMN IF EXISTS deleted_by;
DROP INDEX IF EXISTS idx_drawing_vault_documents_company_id;
