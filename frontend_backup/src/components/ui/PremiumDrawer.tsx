      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <motion.div 
            ...
            transition={spring}
            className={`relative h-full ${widthClasses[width]} bg-[#0a0a0a] shadow-[-20px_0_40px_rgba(0,0,0,0.5)] border-l border-white/5 flex flex-col`}
          >
            {/* Ambient Lighting */}
            <div className="absolute top-0 right-0 w-full h-96 bg-blue-500/5 blur-[120px] pointer-events-none" />
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar relative z-10 bg-[#0a0a0a]">
              {children}
            </div>
          </motion.div>
        </div>
