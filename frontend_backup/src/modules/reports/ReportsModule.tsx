...
export const ReportsModule = ({ projectId }: { projectId?: string }) => {
  ...
  return (
    <div className="flex-1 h-full flex flex-col relative z-0 animate-fade-in p-4 overflow-y-auto custom-scrollbar pt-4">
