    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500 mt-2 font-mono text-sm">Overall Equipment Effectiveness historical analytics</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-black/5 backdrop-blur-xl border border-black/10 rounded-2xl p-6 relative overflow-hidden group hover:border-purple-500/30 transition-all duration-300">
          ...
          <p className="text-4xl font-black text-zinc-900">0.0%</p>
      ...
      <div className="bg-black/5 backdrop-blur-xl border border-black/10 rounded-2xl p-12 text-center">
        <Gauge className="w-12 h-12 text-slate-600 mx-auto mb-4" />
        <h3 className="text-xl font-bold text-zinc-900 mb-2">No Historical Data</h3>
