    ...
    <div className="flex-1 overflow-y-auto pb-12 animate-fade-in relative flex flex-col h-full min-h-0">
      ...
      <div className="flex justify-between items-center shrink-0 mb-4 bg-white/[0.01] border border-white/5 rounded-xl p-3">
        <div className="flex items-center">
          ...
          <h2 className="text-lg font-bold text-white tracking-tight">Project Management & Assembly Scheduling</h2>
        </div>
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center">
              ...
              <span className="text-xs font-bold text-white font-mono">{calculateProgress()}%</span>
            </div>
          </div>
          <button 
      ...
      <div className="grid grid-cols-3 gap-4 flex-1 min-h-0">
        ...
        {/* Task List (Left) */}
        <div className="col-span-2 bg-white/[0.01] border border-white/5 rounded-2xl p-4 overflow-y-auto hide-scrollbar">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xl animate-fade-in">
          <div className="glass-modal w-full max-w-lg p-6 animate-slide-up border border-orange-500/20 relative overflow-hidden">
            ...
            <form onSubmit={handleCreateTask} className="space-y-4 relative z-10">
              <div className="grid grid-cols-1 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-orange-500/50 transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-orange-500/50 transition-all resize-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-orange-500/50 transition-all appearance-none"
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-orange-500/50 transition-all [color-scheme:dark]"
                    />
                  </div>
                  <div>
              ...
              <div className="pt-4 flex justify-end space-x-3 mt-4 border-t border-white/10">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-5 py-2.5 rounded-xl text-sm font-bold text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 transition-colors"
                >
                  Cancel
                </button>
                <button
