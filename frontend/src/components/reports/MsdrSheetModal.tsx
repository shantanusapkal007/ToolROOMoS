  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 pl-16 sm:pl-24 bg-slate-950/70 backdrop-blur-md animate-in fade-in duration-200">
      ...
      <div className="relative w-full max-w-7xl max-h-[92vh] flex flex-col bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl rounded-[12px] border border-white/30 dark:border-slate-700/60 shadow-[0_25px_60px_rgba(0,0,0,0.35)] overflow-hidden">
        {/* Top Header */}
        <div className="p-4 sm:p-5 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white flex items-center justify-between shrink-0 shadow-subtle">
        ...
        <div className="p-3 sm:p-4 bg-slate-100/90 dark:bg-slate-800/90 border-b border-slate-200 dark:border-slate-700/80 flex flex-wrap items-center justify-between gap-3 shrink-0 text-xs">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => addRows(1)}
              className="px-3 py-1.5 rounded-[12px] text-xs font-semibold bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 border border-emerald-500/20 transition-all flex items-center gap-1"
            >
            ...
            <button
              ...
              disabled={isSaving}
              className="px-5 py-1.5 rounded-[12px] text-xs font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 shadow-subtle shadow-emerald-500/20 active:scale-[0.98] transition-all flex items-center gap-1.5"
            >
                ...
                <tr key={row.id} className="hover:bg-emerald-50/60 dark:hover:bg-emerald-950/30 transition-colors">
                  ...
                  <td className="p-0.5 border-r border-slate-200 dark:border-slate-800 text-right">
                    <input
                      ...
                      className="w-full h-8 px-1 text-right font-mono font-semibold text-emerald-600 dark:text-emerald-400 bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 border border-transparent focus:border-emerald-500 focus:outline-none transition-all"
                    />
                  </td>
                  ...
                  <td className="p-0.5 text-center">
                    <div className="flex items-center justify-center gap-1">
                      <button
                        ...
                        className="p-1 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-[12px] transition-colors"
                        title="Duplicate Row"
                      >
        ...
        <div className="p-3 sm:p-4 bg-slate-100/90 dark:bg-slate-800/90 border-t border-slate-200 dark:border-slate-700/80 flex items-center justify-between text-xs shrink-0">
          <div className="flex items-center gap-5 text-slate-600 dark:text-slate-400 font-medium">
            ...
            <span>
              Total Hours:{' '}
              <strong className="text-emerald-600 dark:text-emerald-400 font-semibold text-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleSaveAll}
              disabled={isSaving}
              className="px-6 py-2 rounded-[12px] text-xs font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 shadow-subtle shadow-emerald-500/20 active:scale-[0.98] transition-all flex items-center gap-2"
            >
